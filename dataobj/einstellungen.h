...
private:
	...
	// Knightly : number of months for calculating the weighted average amount of arrived pax/mail at factories
	uint16 factory_arrival_months;
...
public:
	...
	// Knightly : number of months for calculating the weighted average amount of arrived pax/mail at factories
	uint16 get_factory_arrival_months() const { return factory_arrival_months; }
